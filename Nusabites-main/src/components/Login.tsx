...
export function Login({ onLogin, onSwitchToRegister, onBack }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (email && password) {
        ...
        onLogin(email, userName.charAt(0).toUpperCase() + userName.slice(1));
      ...
      <div className="max-w-5xl w-full grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="text-center mb-8">
            ...
            <h1 className="mb-4">Selamat Datang di Nusa Bites</h1>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => toast.info('Fitur login dengan Facebook segera hadir!')}
                >
